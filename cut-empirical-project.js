...
var wasmBinaryFile = 'cut-empirical-project.wasm';
...
var ASM_CONSTS = {
 ...
 1868: function() {console.log('Callstack:\n' + stackTrace());},  
 3344: function($0, $1, $2) {var id = UTF8ToString($0); var setting = UTF8ToString($1); var value = UTF8ToString($2); $( '#' + id ).css( setting, value);},  
 3477: function($0, $1, $2) {var id = UTF8ToString($0); var setting = UTF8ToString($1); var value = UTF8ToString($2); $( '#' + id ).attr( setting, value);},  
 3663: function($0, $1, $2) {var id = UTF8ToString($0); var name = UTF8ToString($1); $( '#' + id ).on( name, function(evt) { emp.Callback($2, evt); } );},  
 4953: function($0, $1) {parent_id = UTF8ToString($0); child_id = UTF8ToString($1); $('#' + parent_id).append('<span id="' + child_id + '"></span>');},  
 5436: function($0, $1) {var div_id = UTF8ToString($0); var div_obj = document.getElementById(div_id); if (div_obj == null) alert(div_id); var scroll_top = $1 * div_obj.scrollHeight; div_obj.scrollTop = scroll_top;},  
 5654: function($0, $1) {var widget_id = UTF8ToString($0); var out_html = UTF8ToString($1); $('#' + widget_id).replaceWith(out_html);},  
 5767: function($0) {var id = UTF8ToString($0); emp_i.cur_obj = $( '#' + id );},  
 5829: function($0, $1) {var name = UTF8ToString($0); var value = UTF8ToString($1); emp_i.cur_obj.css( name, value);},  
 5925: function($0, $1) {var name = UTF8ToString($0); var value = UTF8ToString($1); emp_i.cur_obj.attr( name, value);},  
 6022: function($0, $1) {var name = UTF8ToString($0); emp_i.cur_obj.on( name, function(evt) { emp.Callback($1, evt); } );},  
 6444: function($0) {$( document ).ready(function() { emp.Callback($0); });},  
 6547: function($0, $1) {var fun_name = UTF8ToString($1); emp[fun_name] = function() { emp_i.cb_args = []; for (var i = 0; i < arguments.length; i++) { emp_i.cb_args[i] = arguments[i]; } empCppCallback($0); return emp_i.cb_return; };},  
 7012: function($0) {emp_i.cb_return = $0;}
};
